...
app.get("/api/p/landing", async (req, res) => {
  ...
  if (isBot)
    return res.send("Taller de Pixeles - Desarrollo Web y Sistemas de Gestion");
  res.send(`<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="utf-8">
      ...
      ${[
        {
          ...
          desc: "Paginas institucionales, landing pages, portales corporativos y tiendas en linea con diseño moderno y responsive.",
        },
        {
          icon: "📊",
          title: "Sistemas de Gestion",
          desc: "ERPs, CRM, facturacion, inventario, compras y mas. Automatizamos procesos clave de tu negocio.",
        },
        {
          icon: "🛒",
          title: "Ecommerce",
          desc: "Tiendas online con carrito de compras, pasarela de pago, inventario sincronizado y panel administrativo.",
        },
        {
          icon: "🤖",
          title: "Automatizaciones",
          desc: "Integraciones entre plataformas, bots de WhatsApp, correos automaticos y flujos de trabajo inteligentes.",
        },
        {
          icon: "☁️",
          title: "Hosting & Dominios",
          desc: "Alojamiento web optimizado, certificados SSL, correo corporativo y administracion de dominios.",
        },
        {
          icon: "🔧",
          title: "Soporte Tecnico",
          desc: "Mantenimiento continuo, soporte via ticket, actualizaciones de seguridad y respaldo de datos.",
        },
      ]
        .map(
          (
            s,
          ) => `<div class="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/5 card-hover">
      ...
      ${[
        {
          n: "01",
          t: "Diagnostico",
          d: "Entendemos tu negocio, tus procesos y lo que necesitas lograr.",
        },
        {
          n: "02",
          t: "Propuesta",
          d: "Te presentamos una solucion clara con alcance, tiempos y presupuesto.",
        },
        {
          n: "03",
          t: "Desarrollo",
          d: "Construimos tu solucion con entregas parciales y revision constante.",
        },
        {
          n: "04",
          t: "Entrega & Soporte",
          d: "Implementamos, capacitamos y te acompanamos con soporte continuo.",
        },
      ]
        .map(
...
app.get("/", (req, res) => {
  res.redirect(301, "/api/p/landing");
});
